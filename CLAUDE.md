...
本仓库包含 **PiERN 多模拟器数据合成管线**，集成4个地质物理模拟器，创建首个跨多物理场的地质时序数据集。

**目标**：75,000 Stage 1 样本 + 375,000 Stage 2 文本对 + 37,500 Stage 3 CoT 轨迹

## 当前聚焦（2026-03-15）

**数据集规模大幅提升**：250K样本 + 2,500条模板，超越PDEBench 12.5倍。

### Week 1: MODFLOW 扩展至250K（进行中）
- 🎯 新目标：7,600 → **250,000** 样本（10,000/场景），15 → 25 场景
- ✅ 已完成：
  - 26个配置文件更新为10K规模
  - 模板生成器实现（100模板/场景）
  - 基于模板的Stage 2管线
...
### Week 2: SimPEG 实现（计划中）
- 🎯 目标：新增 20,000 样本（地球物理勘探）
- 📋 待办：MT/DC/TEM 三种方法实现

### Week 3-4: Devito 实现（计划中）
- 🎯 目标：新增 10,000 样本（地震波传播）

### Week 5-6: TOUGH2 实现（计划中）
- 🎯 目标：新增 15,000 样本（多相流体）

### Week 7: Stage 2 扩展（计划中）
- 🎯 目标：6,600 → 375,000 文本对

### Week 8: Stage 3 实现（计划中）
- 🎯 目标：新增 37,500 CoT 轨迹

**详细路线图**：见 `IMPLEMENTATION_ROADMAP.md`
